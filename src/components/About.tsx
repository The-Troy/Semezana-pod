        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="w-32 h-32 bg-gradient-to-br from-brand-yellow to-brand-red rounded-full mx-auto mb-6 flex items-center justify-center">
                {/* 
              ...
              <p className="text-brand-red font-semibold mb-4">Host</p>
          ...
          <div className="text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              <div className="w-32 h-32 bg-gradient-to-br from-brand-red to-brand-yellow rounded-full mx-auto mb-6 flex items-center justify-center">
                {/* 
                  DIRECTORY FOR HOST IMAGES: /public/hosts/
              ...
              <p className="text-brand-red font-semibold mb-4">Co-Host</p>
              <p className="text-gray-600 leading-relaxed">
